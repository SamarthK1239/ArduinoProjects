 ...
 *  
 */
//#include <processing.serial.*> // imports library for serial communication
//#include <java.awt.event.KeyEvent> // imports library for reading the data from the serial port
